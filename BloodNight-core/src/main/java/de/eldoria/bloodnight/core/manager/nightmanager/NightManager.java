...
public class NightManager extends FoliaRunnable implements Listener {
  ...
  public void reload() {
    ...
    timeManager.runAtFixedRate(BloodNight.getInstance(), 1, 5);
    ...
    soundManager.runAtFixedRate(BloodNight.getInstance(), 2, 5);
